...
INT_LINKS['QSLINK'] = {}
INT_LINKS['QSLINK']['toID'] = ('PLACE', 'PATH', 'SPATIAL_ENTITY', 'MOTION', 'EVENT')
INT_LINKS['QSLINK']['fromID'] = ('PLACE', 'PATH', 'SPATIAL_ENTITY', 'MOTION', 'EVENT')
INT_LINKS['QSLINK']['trigger'] = ('SPATIAL_SIGNAL')

INT_LINKS['OLINK'] = {}
INT_LINKS['OLINK']['toID'] = ('PLACE', 'PATH', 'SPATIAL_ENTITY', 'MOTION', 'EVENT')
INT_LINKS['OLINK']['fromID'] = ('PLACE', 'PATH', 'SPATIAL_ENTITY', 'MOTION', 'EVENT')
