...
if __name__ == "__main__":
    ...
    clean_path = './data/baseline/configuration1/0'
    
    hyp_1 = './data/baseline/configuration1/1'
    hyp_a = './data/baseline/configuration1/a'    
    hyp_b = './data/baseline/configuration1/b'   
    hyp_c = './data/baseline/configuration1/c'   
